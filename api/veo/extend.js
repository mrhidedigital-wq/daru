// api/veo/extend.js
// Vercel Serverless Function — proxy para Veo Extend (encadenado para > 8s).
// Reemplaza: POST /api/veo/extend en server.js
// Mismo endpoint que generate — solo se diferencia en que el body incluye un `video`.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error('[veo/extend]', err.message);
